...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center py-3">
            <h5 class="mb-0"><i class="fas fa-list-alt me-2"></i> Laporan Transaksi</h5>
        </div>
                ...
                <form action="{{ route('laporan.transaksi') }}" method="GET">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select form-control" id="bengkel_id" name="bengkel_id">
                    ...
                    <div class="row align-items-end mt-2">
                        ...
                        <div class="col-md-2">
                            @if (request()->has('start_date') || request()->has('status'))
                                <a href="{{ route('laporan.transaksi') }}" class="btn btn-secondary mt-2">
